...
function(e, t) {
    ...
    x(s, {
        bind: function(e) {
            ...
            for (var n = u.call(arguments, 1), i = function() {
            ...
            return t.prototype && (r.prototype = t.prototype, l.prototype = new r, r.prototype = null), l
        }
    });
    var C, k, $, T, M, N = d.bind(a.hasOwnProperty);
    (M = N(a, "__defineGetter__")) && (C = d.bind(a.__defineGetter__), k = d.bind(a.__defineSetter__), $ = d.bind(a.__lookupGetter__), T = d.bind(a.__lookupSetter__));
    var j = function() {
        var e = [1, 2],
            t = e.splice();
    ...
    x(o, {
        splice: function(t, n) {
            ...
            var r = arguments;
            return this.length = Math.max(e(this.length), 0), arguments.length > 0 && "number" != typeof n && (r = u.call(arguments), r.length < 2 ? r.push(this.length - t) : r[1] = e(n)), f.apply(this, r)
        }
    }, !_);
    var D = 1 !== [].unshift(0);
    x(o, {
    ...
    var I = !1;
    o.reduce && (I = "object" == typeof o.reduce.call("es5", function(e, t, n, r) {
        return r
    })), x(o, {
        reduce: function(e) {
            var t = E(this),
    ...
    var A = !1;
    o.reduceRight && (A = "object" == typeof o.reduceRight.call("es5", function(e, t, n, r) {
        return r
    })), x(o, {
    ...
    var L = Array.prototype.indexOf && [0, 1].indexOf(1, 2) !== -1;
    x(o, {
        indexOf: function(t) {
            var n = P && y(this) ? this.split("") : E(this),
                r = n.length >>> 0;
            if (!r) return -1;
            var i = 0;
            for (arguments.length > 1 && (i = e(arguments[1])), i = i >= 0 ? i : Math.max(0, r + i); i < r; i++)
    ...
    x(Object, {
        keys: function(e) {
            ...
            if (i || n)
                ...
                for (var l in e) a && "prototype" === l || !N(e, l) || o.push(String(l));
            if (R)
                for (var c = e.constructor, u = c && c.prototype === e, f = 0; f < q; f++) {
                    var p = B[f];
                    u && "constructor" === p || !N(e, p) || o.push(p)
                }
            return o
        }
    });
    ...
    x(Object, {
        keys: function(e) {
            return U(b(e) ? o.slice.call(e) : e)
        }
    }, !W);
    var X = -621987552e5,
        V = "-000001",
        Z = Date.prototype.toISOString && new Date(X).toISOString().indexOf(V) === -1;
    x(Date.prototype, {
        toISOString: function() {
            var e, t, n, r, i;
            if (!isFinite(this)) throw new RangeError("Date.prototype.toISOString called on non-finite value.");
            for (r = this.getUTCFullYear(), i = this.getUTCMonth(), r += Math.floor(i / 12), i = (i % 12 + 12) % 12, e = [i + 1, this.getUTCDate(), this.getUTCHours(), this.getUTCMinutes(), this.getUTCSeconds()], r = (r < 0 ? "-" : r > 9999 ? "+" : "") + ("00000" + Math.abs(r)).slice(0 <= r && r <= 9999 ? -4 : -6), t = e.length; t--;) n = e[t], n < 10 && (e[t] = "0" + n);
            return r + "-" + e.slice(0, 2).join("-") + "T" + e.slice(2).join(":") + "." + ("000" + this.getUTCMilliseconds()).slice(-3) + "Z"
        }
    }, Z);
    var G = !1;
    try {
        G = Date.prototype.toJSON && null === new Date(NaN).toJSON() && new Date(X).toJSON().indexOf(V) !== -1 && Date.prototype.toJSON.call({
            toISOString: function() {
                return !0
            }
        })
    ...
    var Q = 1e15 === Date.parse("+033658-09-27T01:46:40.000Z"),
        Y = !isNaN(Date.parse("2012-04-04T24:00:00.500Z")) || !isNaN(Date.parse("2012-11-31T23:59:59.000Z")),
        K = isNaN(Date.parse("2000-01-01T00:00:00.000Z"));
    Date.parse && !K && !Y && Q || (Date = function(e) {
        function t(n, r, i, o, a, s, l) {
            var c = arguments.length;
            if (this instanceof e) {
                var u = 1 === c && String(n) === n ? new e(t.parse(n)) : c >= 7 ? new e(n, r, i, o, a, s, l) : c >= 6 ? new e(n, r, i, o, a, s) : c >= 5 ? new e(n, r, i, o, a) : c >= 4 ? new e(n, r, i, o) : c >= 3 ? new e(n, r, i) : c >= 2 ? new e(n, r) : c >= 1 ? new e(n) : new e;
        ...
        return t.now = e.now, t.UTC = e.UTC, t.prototype = e.prototype, t.prototype.constructor = t, t.parse = function t(o) {
            var a = i.exec(o);
            if (a) {
                var s, l = Number(a[1]),
                    t = Number(a[2] || 1) - 1,
                    ...
                    f = Number(a[5] || 0),
                    p = Number(a[6] || 0),
                    d = Math.floor(1e3 * Number(a[7] || 0)),
                    h = Boolean(a[4] && !a[8]),
                    m = "-" === a[9] ? 1 : -1,
                    g = Number(a[10] || 0),
                    v = Number(a[11] || 0);
                return u < (f > 0 || p > 0 || d > 0 ? 24 : 25) && f < 60 && p < 60 && d < 1e3 && t > -1 && t < 12 && g < 24 && v < 60 && c > -1 && c < n(l, t + 1) - n(l, t) && (s = 60 * (24 * (n(l, t) + c) + u + g * m), s = 1e3 * (60 * (s + f + v * m) + p) + d, h && (s = r(s)), -864e13 <= s && s <= 864e13) ? s : NaN
            }
    ...
    var J = c.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9. toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)),
        ee = {
            base: 1e7,
            size: 6,
            data: [0, 0, 0, 0, 0, 0],
            multiply: function(e, t) {
                for (var n = -1; ++n < ee.size;) t += e * ee.data[n], ee.data[n] = t % ee.base, t = Math.floor(t / ee.base)
            },
            divide: function(e) {
                for (var t = ee.size, n = 0; --t >= 0;) n += ee.data[t], ee.data[t] = Math.floor(n / e), n = n % e * ee.base
            },
            numToString: function() {
                for (var e = ee.size, t = ""; --e >= 0;)
                    if ("" !== t || 0 === e || 0 !== ee.data[e]) {
                        var n = String(ee.data[e]);
    ...
    x(c, {
        toFixed: function(e) {
            ...
            if (r = "", n < 0 && (r = "-", n = -n), i = "0", n > 1e-21)
                if (o = ee.log(n * ee.pow(2, 69, 1)) - 69, a = o < 0 ? n * ee.pow(2, -o, 1) : n / ee.pow(2, o, 1), a *= 4503599627370496, o = 52 - o, o > 0) {
                    for (ee.multiply(0, a), s = t; s >= 7;) ee.multiply(1e7, 0), s -= 7;
                    for (ee.multiply(ee.pow(10, s, 1), 0), s = o - 1; s >= 23;) ee.divide(1 << 23), s -= 23;
                    ee.divide(1 << s), ee.multiply(1, 1), ee.divide(2), i = ee.numToString()
                } else ee.multiply(0, a), ee.multiply(1 << -o, 0), i = ee.numToString() + "0.00000000000000000000".slice(2, 2 + t);
            return t > 0 ? (l = i.length, i = l <= t ? r + "0.0000000000000000000".slice(0, t - l + 2) + i : r + i.slice(0, l - t) + "." + i.slice(l - t)) : i = r + i, i
        }
    }, J);
    var te = l.split;
    2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? ! function() {
        ...
        l.split = function(t, n) {
            ...
            if ("[object RegExp]" !== h.call(t)) return te.call(this, t, n);
            var i, a, s, l, c = [],
                u = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.extended ? "x" : "") + (t.sticky ? "y" : ""),
                f = 0;
            for (t = new RegExp(t.source, u + "g"), r += "", e || (i = new RegExp("^" + t.source + "$(?!\\s)", u)), n = void 0 === n ? -1 >>> 0 : S(n);
                ...
                }), a.length > 1 && a.index < r.length && o.push.apply(c, a.slice(1)), l = a[0].length, f = s, c.length >= n)));) t.lastIndex === a.index && t.lastIndex++;
            return f === r.length ? !l && t.test("") || c.push("") : c.push(r.slice(f)), c.length > n ? c.slice(0, n) : c
        }
    }() : "0".split(void 0, 0).length && (l.split = function(e, t) {
        return void 0 === e && 0 === t ? [] : te.call(this, e, t)
    });
    var ne = l.replace,
        re = function() {
            var e = [];
    ...
    x(l, {
        substr: function(e, t) {
            return ie.call(this, e < 0 && (e = this.length + e) < 0 ? 0 : e, t)
        }
    }, oe);
    var ae = "\t\n\v\f\r В бљЂб ЋвЂЂвЂЃвЂ‚вЂѓвЂ„вЂ…вЂ†вЂ‡вЂ€вЂ‰вЂЉвЂЇвЃџгЂЂ\u2028\u2029\ufeff",
        ...
        ce = new RegExp("^" + le + le + "*"),
        ue = new RegExp(le + le + "*$"),
        fe = l.trim && (ae.trim() || !se.trim());
    x(l, {
        trim: function() {
            if (void 0 === this || null === this) throw new TypeError("can't convert " + this + " to object");
            return String(this).replace(ce, "").replace(ue, "")
        }
    }, fe), 8 === parseInt(ae + "08") && 22 === parseInt(ae + "0x16") || (parseInt = function(e) {
        var t = /^0[xX]/;
        return function(n, r) {
    ...
    function a(e, n, r) {
        ...
        r || (r = o(n));
        var i;
        return i = r.cache[e] ? r.cache[e].cloneNode() : w.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !i.canHaveChildren || b.test(e) || i.tagUrn ? i : r.frag.appendChild(i)
    }
    ...
    function c(e) {
        e || (e = t);
        var r = o(e);
        return !C.shivCSS || m || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), g || l(e, r), e
    }
    ...
    function f(e) {
        for (var t, n = e.attributes, r = n.length, i = e.ownerDocument.createElement($ + ":" + e.nodeName); r--;) t = n[r], t.specified && i.setAttribute(t.nodeName, t.nodeValue);
        return i.style.cssText = e.style.cssText, i
    }

    function p(e) {
        for (var t, n = e.split("{"), i = n.length, o = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), a = "$1" + $ + "\\:$2"; i--;) t = n[i] = n[i].split("}"), t[t.length - 1] = t[t.length - 1].replace(o, a), n[i] = t.join("}");
        return n.join("{")
    }
    ...
    function h(e) {
        ...
        var r, i, a = o(e),
            s = e.namespaces,
            l = e.parentWindow;
        return !T || e.printShived ? e : ("undefined" == typeof s[$] && s.add($), l.attachEvent("onbeforeprint", function() {
            t();
            for (var o, a, s, l = e.styleSheets, c = [], f = l.length, d = Array(f); f--;) d[f] = l[f];
            for (; s = d.pop();)
                if (!s.disabled && k.test(s.media)) {
                    ...
                    for (f = 0; a > f; f++) d.push(o[f]);
                    try {
                        c.push(s.cssText)
                    } catch (e) {}
                }
            c = p(c.reverse().join("")), i = u(e), r = n(e, c)
    ...
    C.type += " print", C.shivPrint = h, h(t)
    ...
    function a(e, n, r) {
        ...
        r || (r = o(n));
        var i;
        return i = r.cache[e] ? r.cache[e].cloneNode() : m.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !i.canHaveChildren || h.test(e) || i.tagUrn ? i : r.frag.appendChild(i)
    }
    ...
    function c(e) {
        e || (e = t);
        var r = o(e);
        return !b.shivCSS || u || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), f || l(e, r), e
    }
    var u, f, p = "3.7.2",
        d = e.html5 || {},
    ...
    e.html5 = b, c(t)
}(this, document), window.Modernizr = function(e, t, n) {
        function r(e) {
            b.cssText = e
        }
        ...
        function c(e, t, n) {
            ...
            return o(t, "string") || o(t, "undefined") ? s(i, t) : (i = (e + " " + $.join(r + " ") + r).split(" "), l(i, t, n))
        }

        function u() {
            h.input = function(n) {
                for (var r = 0, i = n.length; i > r; r++) j[n[r]] = !!(n[r] in w);
                ...
                for (var r, i, o, a = 0, s = e.length; s > a; a++) w.setAttribute("type", i = e[a]), r = "text" !== w.type, r && (w.value = x, w.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(i) && w.style.WebkitAppearance !== n ? (g.appendChild(w), o = t.defaultView, r = o.getComputedStyle && "textfield" !== o.getComputedStyle(w, null).WebkitAppearance && 0 !== w.offsetHeight, g.removeChild(w)) : /^(search|tel)$/.test(i) || (r = /^(url|email)$/.test(i) ? w.checkValidity && w.checkValidity() === !1 : w.value != x)), N[e[a]] = !!r;
                return N
        ...
        var f, p, d = "2.8.3",
            ...
            O = function(e, n, r, i) {
                ...
                if (parseInt(r, 10))
                    for (; r--;) s = t.createElement("div"), s.id = i ? i[r] : v + (r + 1), c.appendChild(s);
                return o = ["&#173;", '<style id="s', v, '">', e, "</style>"].join(""), c.id = v, (u ? c : f).innerHTML += o, f.appendChild(c), u || (f.style.background = "", f.style.overflow = "hidden", l = g.style.overflow, g.style.overflow = "hidden", g.appendChild(f)), a = n(c, e), u ? c.parentNode.removeChild(c) : (f.parentNode.removeChild(f), g.style.overflow = l), !!a
            },
            P = function(t) {
            ...
            I = {}.hasOwnProperty;
        p = o(I, "undefined") || o(I.call, "undefined") ? function(e, t) {
            ...
            var n = D.call(arguments, 1),
                r = function() {
                    if (this instanceof r) {
                        ...
                        var o = new i,
                            a = t.apply(o, n.concat(D.call(arguments)));
            ...
            return !!t.createElementNS && /SVGAnimate/.test(E.call(t.createElementNS(T.svg, "animate")))
        }, M.svgclippaths = function() {
            return !!t.createElementNS && /SVGClipPath/.test(E.call(t.createElementNS(T.svg, "clipPath")))
        };
        for (var A in M) p(M, A) && (f = A.toLowerCase(), h[f] = M[A](), _.push((h[f] ? "" : "no-") + f));
        return h.input || u(), h.addTest = function(e, t) {
            ...
            function(e, t) {
                ...
                function o(e, n, r) {
                    ...
                    r || (r = i(n));
                    var o;
                    return o = r.cache[e] ? r.cache[e].cloneNode() : h.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !o.canHaveChildren || d.test(e) || o.tagUrn ? o : r.frag.appendChild(o)
                }
                ...
                function l(e) {
                    e || (e = t);
                    var r = i(e);
                    return !y.shivCSS || c || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || s(e, r), e
                }
                var c, u, f = "3.7.0",
                    p = e.html5 || {},
                ...
                e.html5 = y, l(t)
            }(this, t), h._version = d, h._prefixes = S, h._domPrefixes = $, h._cssomPrefixes = k, h.mq = P, h.hasEvent = F, h.testProp = function(e) {
                return s([e])
            }, h.testAllProps = c, h.testStyles = O, h.prefixed = function(e, t, n) {
                return t ? c(e, t, n) : c(e, "pfx")
            }, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (m ? " js " + _.join(" ") : ""), h
    }(this, this.document),
    function(e) {
        e.extend({
    ...
    function(e) {
            ...
            smoothScroll: function() {
                    ...
                    if (document.URL.indexOf("google.com/reader/view") > -1 && (e = !0), b.excluded) {
                        ...
                        for (var n = t.length; n--;)
                            if (document.URL.indexOf(t[n]) > -1) {
                                v && v.disconnect(), c("mousewheel", r), e = !0, w = !0;
                                break
                            }
                    }
                ...
                function t() {
                    if (document.body) {
                        var t = document.body,
                            ...
                            i = t.scrollHeight;
                        if (C = document.compatMode.indexOf("CSS") >= 0 ? n : t, g = t, e(), S = !0, top != self) x = !0;
                            ...
                            if (v = new P(a), v.observe(t, s), C.offsetHeight <= r) {
                        ...
                        b.fixedBackground || w || (t.style.backgroundAttachment = "scroll", n.style.backgroundAttachment = "scroll")
                    }
                }

                function n(e, t, n, r) {
                    if (r || (r = 1e3), f(t, n), 1 != b.accelerationMax) {
                        var i = +new Date,
                            o = i - N;
                    ...
                    if (T.push({
                        ...
                        var s = e === document.body,
                            l = function(i) {
                                for (var o = +new Date, a = 0, c = 0, u = 0; u < T.length; u++) {
                                    var f = T[u],
                                        p = o - f.start,
                                        d = p >= b.animationTime,
                                        h = d ? 1 : p / b.animationTime;
                                    b.pulseAlgorithm && (h = m(h));
                                    var g = f.x * h - f.lastX >> 0,
                                        v = f.y * h - f.lastY >> 0;
                                    a += g, c += v, f.lastX += g, f.lastY += v, d && (T.splice(u, 1), u--)
                                }
                                s ? window.scrollBy(a, c) : (a && (e.scrollLeft += a), c && (e.scrollTop += c)), t || n || (T = []), T.length ? O(l, e, r / b.frameRate + 1) : M = !1
                            };
                        O(l, e, 0), M = !0
                    }
                }
                ...
                function r(e) {
                    ...
                    var o = e.wheelDeltaX || 0,
                        a = e.wheelDeltaY || 0;
                    return o || a || (a = e.wheelDelta || 0), !(b.touchpadSupport || !p(a)) || (Math.abs(o) > 1.2 && (o *= b.stepSize / 120), Math.abs(a) > 1.2 && (a *= b.stepSize / 120), n(i, -o, -a), void e.preventDefault())
                }

                function i(e) {
                    var t = e.target,
                        r = e.ctrlKey || e.altKey || e.metaKey || e.shiftKey && e.keyCode !== $.spacebar;
                ...
                function a(e, t) {
                    for (var n = e.length; n--;) j[D(e[n])] = t;
                    return t
                }
                ...
                function s(e) {
                    ...
                    do {
                        ...
                        if (t.push(e), n === e.scrollHeight) {
                            if (!x || C.clientHeight + 10 < n) return a(t, document.body)
                ...
                function f(e, t) {
                    e = e > 0 ? 1 : -1, t = t > 0 ? 1 : -1, E.x === e && E.y === t || (E.x = e, E.y = t, T = [], N = 0)
                }

                function p(e) {
                    if (e) {
                        e = Math.abs(e), k.push(e), k.shift(), clearTimeout(_);
                        var t = k[0] == k[1] && k[1] == k[2],
                            n = d(k[0], 120) && d(k[1], 120) && d(k[2], 120);
                        return !(t || n)
                    }
                }
        ...
        e.matchMedia = e.matchMedia || function(e) {
            ...
            return o.id = "mq-test-1", o.style.cssText = "position:absolute;top:-100em", i.style.background = "none", i.appendChild(o),
                function(e) {
                    return o.innerHTML = '&shy;<style media="' + e + '"> #mq-test-1 { width: 42px; }</style>', n.insertBefore(i, r), t = 42 === o.offsetWidth, n.removeChild(i), {
                        matches: t,
                        media: e
                    }
                }
    ...
    function(e) {
        ...
        if (n.ajax = o, n.queue = r, n.unsupportedmq = a, n.regex = {
                media: /@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi,
            ...
            var s, l, c, u = e.document,
                ...
                m = {},
                g = 30,
                v = u.getElementsByTagName("head")[0] || f,
                ...
                x = function(t) {
                    var n = "clientWidth",
                        ...
                        a = b[b.length - 1],
                        m = (new Date).getTime();
                    if (t && s && g > m - s) return e.clearTimeout(l), void(l = e.setTimeout(x, g));
                    s = m;
                    for (var y in p)
                        if (p.hasOwnProperty(y)) {
                            var E = p[y],
                                ...
                                $ = null === C,
                                T = "em";
                            S && (S = parseFloat(S) * (S.indexOf(T) > -1 ? c || w() : 1)), C && (C = parseFloat(C) * (C.indexOf(T) > -1 ? c || w() : 1)), E.hasquery && (k && $ || !(k || i >= S) || !($ || C >= i)) || (o[E.media] || (o[E.media] = []), o[E.media].push(d[E.rules]))
                        }
                    for (var M in h) h.hasOwnProperty(M) && h[M] && h[M].parentNode === v && v.removeChild(h[M]);
                    h.length = 0;
                    for (var N in o)
                        if (o.hasOwnProperty(N)) {
                            var j = u.createElement("style"),
                                _ = o[N].join("\n");
                            j.type = "text/css", j.media = N, v.insertBefore(j, a.nextSibling), j.styleSheet ? j.styleSheet.cssText = _ : j.appendChild(u.createTextNode(_)), h.push(j)
                        }
                },
                E = function(e, t, r) {
                    ...
                    for (var c = 0; o > c; c++) {
                        var u, f, h, m;
                        l ? (u = r, d.push(s(e))) : (u = i[c].match(n.regex.findStyles) && RegExp.$1, d.push(RegExp.$2 && s(RegExp.$2))), h = u.split(","), m = h.length;
                        for (var g = 0; m > g; g++) f = h[g], a(f) || p.push({
                ...
                S = function() {
                    if (r.length) {
                        var t = r.shift();
                        o(t.href, function(n) {
                            E(n, t.href, t.media), m[t.href] = !0, e.setTimeout(function() {
                                S()
                            }, 0)
                        })
                    }
                ...
                C = function() {
                    for (var t = 0; t < b.length; t++) {
                        ...
                        i && a && !m[i] && (n.styleSheet && n.styleSheet.rawCssText ? (E(n.styleSheet.rawCssText, i, o), m[i] = !0) : (!/^([a-zA-Z:]*\/\/)/.test(i) && !y || i.replace(RegExp.$1, "").split("/")[0] === e.location.host) && ("//" === i.substring(0, 2) && (i = e.location.protocol + i), r.push({
                            href: i,
                            media: o
                        })))
                    }
            ...
            C(), n.update = C, n.getEmValue = w, e.addEventListener ? e.addEventListener("resize", t, !1) : e.attachEvent && e.attachEvent("onresize", t)
        }
    }(this);